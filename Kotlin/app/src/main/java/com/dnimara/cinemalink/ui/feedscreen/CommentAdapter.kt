...
class CommentAdapter(val viewModel: PostViewModel):
    ListAdapter<CommentDto, CommentAdapter.ViewHolder>(DiffCallback) {

    class ViewHolder private constructor(val binding: ListItemCommentBinding):
        RecyclerView.ViewHolder(binding.root) {

            @SuppressLint("ClickableViewAccessibility")
            fun bind(item: CommentDto, viewModel: PostViewModel) {
